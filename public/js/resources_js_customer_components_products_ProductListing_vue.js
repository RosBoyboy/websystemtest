...
var render = function render() {
  ...
  return _c("CustomerLayout", [_c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.meta.total) + " products")]) : _vm._e()]), _vm._v(" "), _c("div", {
    ...
    staticClass: "bg-slate-900 border border-slate-700 text-white rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-orange-500 transition-colors w-auto",
    on: {
  ...
  }, [_vm._v("Price: High to Low")])]), _vm._v(" "), _c("button", {
    staticClass: "flex items-center gap-2 border border-slate-700 hover:border-orange-500 text-white rounded-lg px-4 py-2 text-sm transition-colors uppercase tracking-wider font-semibold",
    staticStyle: {
      "font-family": "'Syne',sans-serif"
    },
    on: {
      click: function click($event) {
        _vm.filterPanelOpen = !_vm.filterPanelOpen;
      }
    }
  }, [_c("svg", {
    staticClass: "w-4 h-4",
  ...
  })]), _vm._v("\n          Filters\n          "), _vm.activeFilterCount ? _c("span", {
    staticClass: "bg-orange-500 text-black font-bold text-xs rounded-full w-5 h-5 flex items-center justify-center leading-none"
  }, [_vm._v(_vm._s(_vm.activeFilterCount))]) : _vm._e()])])]), _vm._v(" "), _vm.filterPanelOpen ? _c("div", {
    staticClass: "bg-slate-900 rounded-2xl border border-slate-700 p-6 mb-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6"
  }, [_c("div", [_c("label", {
    ...
    on: {
      keyup: function keyup($event) {
        if (!$event.type.indexOf("key") && _vm._k($event.keyCode, "enter", 13, $event.key, "Enter")) return null;
        return _vm.fetchProducts.apply(null, arguments);
      },
      input: function input($event) {
        if ($event.target.composing) return;
    ...
    staticClass: "flex items-end gap-2"
  }, [_c("button", {
    staticClass: "bg-orange-500 hover:bg-orange-600 text-black font-bold text-sm py-2 rounded-lg flex-1 transition-colors uppercase tracking-wider",
    on: {
      click: _vm.applyFilters
    }
  }, [_vm._v("Apply")]), _vm._v(" "), _c("button", {
    staticClass: "bg-transparent border border-slate-600 hover:border-slate-400 text-slate-300 hover:text-white text-sm py-2 rounded-lg flex-1 transition-colors uppercase tracking-wider",
    on: {
      click: _vm.clearFilters
    }
  }, [_vm._v("Clear")])])]) : _vm._e(), _vm._v(" "), _vm.loading ? _c("div", {
