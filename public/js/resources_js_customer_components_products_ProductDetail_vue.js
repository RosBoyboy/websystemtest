...
var render = function render() {
  ...
  return _c("CustomerLayout", [_vm.loading ? _c("div", {
    ...
    staticClass: "text-sm text-slate-400 mb-6 flex items-center gap-2"
  }, [_c("router-link", {
  ...
  }, [_vm._v("Home")]), _vm._v(" "), _c("span", [_vm._v("/")]), _vm._v(" "), _c("router-link", {
    staticClass: "hover:text-slate-200 transition-colors",
    attrs: {
      to: {
        name: "products"
  ...
  }, [_vm._v("Shop")]), _vm._v(" "), _c("span", [_vm._v("/")]), _vm._v(" "), _c("span", {
    staticClass: "text-slate-200"
  }, [_vm._v(_vm._s(_vm.product.name))])], 1), _vm._v(" "), _c("div", {
