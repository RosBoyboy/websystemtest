"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_customer_components_orders_OrderTracking_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/customer/components/orders/OrderTracking.vue?vue&type=script&lang=js"
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/customer/components/orders/OrderTracking.vue?vue&type=script&lang=js ***!
  \***********************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var STEP_ORDER = TRACKING_STEPS.map(function (s) {
  return s.key;
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'OrderTracking',
  ...
  methods: {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              ...
              _context2.p = 1;
              _context2.n = 2;
              return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('/account/orders/' + id);
            case 2:
              _yield$axios$get2 = _context2.v;
              data = _yield$axios$get2.data;
              _this2.activeOrder = data;
              _context2.n = 4;
              break;
            case 3:
              _context2.p = 3;
              _t2 = _context2.v;
              _this2.activeOrder = null;
            case 4:
    ...
    productImage: function productImage(product) {
    ...
    itemStatusClass: function itemStatusClass(status) {
      var map = {
    ...
    isStepDone: function isStepDone(key) {
      if (!this.activeOrder || !this.activeOrder.delivery) return false;
      var cur = this.activeOrder.delivery.status;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/customer/components/orders/OrderTracking.vue?vue&type=template&id=daf23afe"
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/customer/components/orders/OrderTracking.vue?vue&type=template&id=daf23afe ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c("CustomerLayout", [_c("div", {
  ...
  }, [_vm.activeOrder ? _c("div", [_c("button", {
    ...
    staticClass: "flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-3"
  }, [_c("div", [_c("h1", {
  ...
  }, [_vm._v("Order #" + _vm._s(_vm.activeOrder.order_number))]), _vm._v(" "), _c("p", {
    staticClass: "text-slate-400 text-sm mt-0.5"
  }, [_vm._v("Placed " + _vm._s(_vm.formatDate(_vm.activeOrder.created_at)))])]), _vm._v(" "), _c("span", {
    "class": ["badge text-sm px-3 py-1.5", _vm.statusClass(_vm.activeOrder.status)]
  }, [_vm._v(_vm._s(_vm.activeOrder.status))])]), _vm._v(" "), _vm.activeOrder.delivery ? _c("div", {
  ...
  }, [_vm._v("Tracking #: "), _c("span", {
    staticClass: "font-semibold text-white"
  }, [_vm._v(_vm._s(_vm.activeOrder.delivery.tracking_number))])]), _vm._v(" "), _c("span", {
    staticClass: "text-slate-600"
  }, [_vm._v("|")]), _vm._v(" "), _c("p", {
    staticClass: "text-sm text-slate-400"
  }, [_vm._v(_vm._s(_vm.activeOrder.delivery.carrier))])]), _vm._v(" "), _c("div", {
    staticClass: "flex items-center gap-1 sm:gap-2"
  }, _vm._l(_vm.trackingSteps, function (step, i) {
    return _c("div", {
      key: step.key,
      staticClass: "flex items-center flex-1"
    }, [_c("div", {
      staticClass: "flex flex-col items-center relative flex-1"
    }, [_c("div", {
      "class": ["w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all", _vm.isStepDone(step.key) ? "bg-orange-500 text-black" : _vm.isCurrentStep(step.key) ? "bg-orange-500 text-black ring-4 ring-orange-400/50 shadow-[0_0_20px_rgba(249,115,22,0.7)] animate-pulse" : "bg-slate-800 text-slate-500"]
    }, [_vm.isStepDone(step.key) ? _c("svg", {
      staticClass: "w-4 h-4",
      attrs: {
        fill: "none",
        stroke: "currentColor",
    ...
    })]) : _c("span", [_vm._v(_vm._s(i + 1))])]), _vm._v(" "), _c("p", {
      "class": ["text-xs mt-2 text-center leading-tight hidden sm:block", _vm.isCurrentStep(step.key) ? "text-orange-400 font-bold drop-shadow-[0_0_5px_rgba(249,115,22,0.8)]" : "text-slate-400"]
    }, [_vm._v(_vm._s(step.label))])]), _vm._v(" "), i < _vm.trackingSteps.length - 1 ? _c("div", {
      "class": ["h-0.5 flex-1 mx-1 transition-colors", _vm.isStepDone(step.key) ? "bg-orange-500" : "bg-slate-800"]
    }) : _vm._e()]);
  }), 0), _vm._v(" "), _vm.activeOrder.delivery.estimated_delivery ? _c("p", {
  ...
  }, _vm._l(_vm.activeOrder.items, function (item) {
    return _c("div", {
      key: item.id,
      staticClass: "flex items-start gap-4 p-4 bg-slate-800 rounded-xl"
    }, [_c("div", {
      staticClass: "w-16 h-16 bg-slate-700 rounded-xl overflow-hidden flex-shrink-0"
    }, [item.product && _vm.productImage(item.product) ? _c("img", {
      staticClass: "w-full h-full object-cover",
      attrs: {
        src: _vm.productImage(item.product),
    ...
    }, [_vm._v(_vm._s(item.product ? item.product.name : "Product"))]), _vm._v(" "), _c("div", {
      staticClass: "flex gap-3 text-xs text-slate-400 mt-0.5"
    }, [item.size ? _c("span", [_vm._v("Size: " + _vm._s(item.size))]) : _vm._e(), _vm._v(" "), item.color ? _c("span", [_vm._v("Color: " + _vm._s(item.color))]) : _vm._e(), _vm._v(" "), _c("span", [_vm._v("Qty: " + _vm._s(item.quantity))])]), _vm._v(" "), _c("div", {
      staticClass: "mt-2 flex items-center gap-2"
    }, [_c("span", {
      staticClass: "text-xs text-slate-500"
    }, [_vm._v("Seller:")]), _vm._v(" "), _c("span", {
      "class": ["text-xs px-2 py-1 rounded-full font-medium", _vm.itemStatusClass(item.status)]
    }, [_vm._v("\n                  " + _vm._s(item.status || "pending") + "\n                ")]), _vm._v(" "), item.seller ? _c("span", {
      staticClass: "text-xs text-slate-500"
    }, [_vm._v(_vm._s(item.seller.store_name))]) : _vm._e()])]), _vm._v(" "), _c("p", {
      staticClass: "font-bold text-orange-500 text-sm flex-shrink-0"
    }, [_vm._v("$" + _vm._s(parseFloat(item.total_price).toFixed(2)))])]);
  }), 0)]), _vm._v(" "), _c("div", {
    staticClass: "bg-slate-900 rounded-2xl border border-slate-700 p-6 max-w-sm ml-auto"
  }, [_c("div", {
  ...
  }, [_vm._v("$" + _vm._s(parseFloat(_vm.activeOrder.subtotal).toFixed(2)))])]), _vm._v(" "), _c("div", {
    staticClass: "flex justify-between text-slate-400"
  }, [_c("span", [_vm._v("Shipping")]), _vm._v(" "), _c("span", {
    staticClass: "text-white"
  }, [_vm._v("$" + _vm._s(parseFloat(_vm.activeOrder.shipping_fee || 0).toFixed(2)))])]), _vm._v(" "), _c("div", {
    staticClass: "flex justify-between font-bold text-white text-base border-t border-slate-700 pt-3 mt-2"
    ...
    return _c("div", {
      key: n,
      staticClass: "h-24 bg-slate-900 rounded-2xl animate-pulse border border-slate-800"
    });
  }), 0) : _vm.orders.length === 0 ? _c("div", {
    staticClass: "text-center py-20"
  }, [_c("svg", {
    staticClass: "w-14 h-14 mx-auto text-slate-700 mb-4",
    attrs: {
      fill: "none",
      stroke: "currentColor",
      "stroke-width": "1.5",
    ...
    staticClass: "text-lg font-bold text-slate-400 mb-2"
  }, [_vm._v("No orders yet")]), _vm._v(" "), _c("p", {
    staticClass: "text-slate-500 text-sm mb-6"
  }, [_vm._v("Your order history will appear here.")]), _vm._v(" "), _c("router-link", {
    staticClass: "bg-orange-500 hover:bg-orange-600 text-black font-bold uppercase tracking-wider text-sm px-6 py-3 rounded-lg transition-colors inline-block",
    attrs: {
      to: {
        name: "products"
      }
    }
  }, [_vm._v("Start Shopping")])], 1) : _c("div", {
    staticClass: "space-y-4"
    ...
    return _c("div", {
      ...
      staticClass: "flex flex-col sm:flex-row sm:items-center justify-between gap-3"
    }, [_c("div", [_c("p", {
      staticClass: "font-bold text-white group-hover:text-orange-500 transition-colors"
    }, [_vm._v("\n                Order #" + _vm._s(order.order_number) + "\n              ")]), _vm._v(" "), _c("p", {
      staticClass: "text-sm text-slate-400 mt-0.5"
      ...
      staticClass: "font-bold text-white group-hover:text-orange-500 transition-colors"
    }, [_vm._v("$" + _vm._s(parseFloat(order.total).toFixed(2)))]), _vm._v(" "), _c("svg", {
      staticClass: "w-4 h-4 text-slate-500 group-hover:text-orange-500 transition-colors",
      attrs: {
        fill: "none",
        stroke: "currentColor",
        "stroke-width": "2",
    ...
    })])])]), _vm._v(" "), order.items && order.items.length ? _c("div", {
      staticClass: "flex gap-2 mt-4"
    }, [_vm._l(order.items.slice(0, 4), function (item) {
      return _c("div", {
        key: item.id,
        staticClass: "w-12 h-12 bg-slate-800 rounded-lg overflow-hidden flex-shrink-0"
      }, [item.product && _vm.productImage(item.product) ? _c("img", {
        staticClass: "w-full h-full object-cover",
        attrs: {
          src: _vm.productImage(item.product),
    ...
    }), _vm._v(" "), order.items.length > 4 ? _c("div", {
      staticClass: "w-12 h-12 bg-slate-800 rounded-lg flex items-center justify-center text-xs text-slate-400 font-medium"
    }, [_vm._v("\n              +" + _vm._s(order.items.length - 4) + "\n            ")]) : _vm._e()], 2) : _vm._e()]);
  }), 0), _vm._v(" "), _vm.meta.last_page > 1 ? _c("div", {
    staticClass: "flex justify-center gap-2 mt-8"
  }, [_c("button", {
    staticClass: "border border-slate-700 hover:border-slate-500 text-slate-300 py-2 px-4 rounded-lg text-sm disabled:opacity-40 disabled:cursor-not-allowed transition-colors uppercase tracking-wider font-bold",
    attrs: {
      disabled: _vm.meta.current_page === 1
    },
    on: {
      click: function click($event) {
        return _vm.fetchOrders(_vm.meta.current_page - 1);
      }
    }
  }, [_vm._v("← Prev")]), _vm._v(" "), _c("span", {
    staticClass: "py-2 px-4 text-sm text-slate-400 font-bold"
  }, [_vm._v(_vm._s(_vm.meta.current_page) + " / " + _vm._s(_vm.meta.last_page))]), _vm._v(" "), _c("button", {
    staticClass: "border border-slate-700 hover:border-slate-500 text-slate-300 py-2 px-4 rounded-lg text-sm disabled:opacity-40 disabled:cursor-not-allowed transition-colors uppercase tracking-wider font-bold",
    attrs: {
...
/***/ "./resources/js/customer/components/orders/OrderTracking.vue"
/*!*******************************************************************!*\
  !*** ./resources/js/customer/components/orders/OrderTracking.vue ***!
  \*******************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _OrderTracking_vue_vue_type_template_id_daf23afe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./OrderTracking.vue?vue&type=template&id=daf23afe */ "./resources/js/customer/components/orders/OrderTracking.vue?vue&type=template&id=daf23afe");
/* harmony import */ var _OrderTracking_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./OrderTracking.vue?vue&type=script&lang=js */ "./resources/js/customer/components/orders/OrderTracking.vue?vue&type=script&lang=js");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _OrderTracking_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _OrderTracking_vue_vue_type_template_id_daf23afe__WEBPACK_IMPORTED_MODULE_0__.render,
  _OrderTracking_vue_vue_type_template_id_daf23afe__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
if (false) // removed by dead control flow
{ var api; }
component.options.__file = "resources/js/customer/components/orders/OrderTracking.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/customer/components/orders/OrderTracking.vue?vue&type=script&lang=js"
/*!*******************************************************************************************!*\
  !*** ./resources/js/customer/components/orders/OrderTracking.vue?vue&type=script&lang=js ***!
  \*******************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderTracking_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./OrderTracking.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/customer/components/orders/OrderTracking.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderTracking_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/customer/components/orders/OrderTracking.vue?vue&type=template&id=daf23afe"
/*!*************************************************************************************************!*\
  !*** ./resources/js/customer/components/orders/OrderTracking.vue?vue&type=template&id=daf23afe ***!
  \*************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderTracking_vue_vue_type_template_id_daf23afe__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderTracking_vue_vue_type_template_id_daf23afe__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_OrderTracking_vue_vue_type_template_id_daf23afe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./OrderTracking.vue?vue&type=template&id=daf23afe */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/customer/components/orders/OrderTracking.vue?vue&type=template&id=daf23afe");
