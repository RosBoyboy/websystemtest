...
var render = function render() {
  ...
  return _c("CustomerLayout", [_c("div", {
    ...
    return _c("div", {
      ...
      "class": ["w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all", _vm.isStepDone(step.key) ? "bg-orange-500 text-black" : _vm.isCurrentStep(step.key) ? "bg-white text-black ring-4 ring-white/20" : "bg-slate-800 text-slate-500"]
      ...
      staticClass: "text-xs text-slate-400 mt-2 text-center leading-tight hidden sm:block"
