...
const routes = [
    ...
    { path: '/orders',        name: 'orders',      component: OrderTracking,   meta: { auth: true } },    { path: '/orders/status/:status', name: 'orders-status', component: OrderTracking, meta: { auth: true } },    { path: '/orders/:id',    name: 'order-detail',component: OrderTracking,   meta: { auth: true } },
